$(document).ready(function(){
  ...
  var FileUploadComponent = React.createClass({displayName: "FileUploadComponent",
    selectFile: function(e){
      alert("as");
      React.findDOMNode(this.refs.fileUpload).trigger("click");
    },
      ...
      return (
        React.createElement("div", {id: "fileUploadComponent"}, 
          ...
          React.createElement("form", {id: "uploadForm", onSubmit: this.onSubmit, encType: "multipart/form-data"}, 
            React.createElement("input", {type: "file", id: "fileElement", name: "file", ref: "fileUpload", style: "display:none;"}), 
            React.createElement("button", {type: "button", className: "btn btn-default btn-small", onClick: this.selectFile}, "Select File"), React.createElement("br", null), 
            React.createElement("input", {type: "submit", className: "btn btn-primary", value: "Upload"})
          )
        )
      );
    }
